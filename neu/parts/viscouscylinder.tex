...
\begin{table}[htp]
	...
	\begin{minipage}[b]{0.3\textwidth}	
			\begin{tabular}{|c|c|c|c|c|}
				...
				\multicolumn{2}{|c|}{}                       & 32     & 64    & 128    \\ \hline
