...
\label{fundamentals}
	\section{Essential Equations}
		...
		\end{align}
		Using this definition combined with the ideal gas law and an equation for the change of entropy as found in \cite{mueller2014} leads to the useful relations \todo{isentropy!}
		\begin{align}
