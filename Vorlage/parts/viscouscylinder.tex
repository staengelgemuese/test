...
\section{Simulations}
	...
	\begin{table}[htp]
		...
		\begin{tabular}{|c||c|c|c|c}
			...
			\rule{0pt}{2,3ex}$C_D$                & $2.27638400267312$        & $2.3205402064175$        & $2.41364044322$        &  \\ \cline{1-4}
			\rule{0pt}{2,3ex}$C_L$                & $-0.000550594258569958$        & $-0.0014617338683891$        & $0.00004720682$        &  \\ \cline{1-4}
		\end{tabular}
	...
	\subsubsection{Simulation at Reynolds Number 20}
		...
		\begin{table}[htp]
			...
			\begin{tabular}{|c||c|c|c|c}
				...
				\rule{0pt}{2,3ex}& $32 \times 32$       & $64 \times 64$       & $128 \times 128$      &  \\ \cline{1-4}
				\rule{0pt}{2,3ex}$W^*$ 				 & a        & b        & c        &  \\ \cline{1-4}
				\rule{0pt}{2,3ex}$C_D$                & $1.64383538515868$        & $1.63699061840009$        & $1.63699061840009$       &  \\ \cline{1-4}
				\rule{0pt}{2,3ex}$C_L$                & $-0.000670676506459244$       & $-0.000694847445600998$       & $-0.000694847445600998$        &  \\ \cline{1-4}
			\end{tabular}
	...
	\subsubsection{Simulation at Reynolds Number 40}
		\begin{table}[htp]
			...
			\begin{tabular}{|c||c|c|c|c}
				...
				\rule{0pt}{2,3ex}& $32 \times 32$       & $64 \times 64$       & $128 \times 128$      &  \\ \cline{1-4}
				\rule{0pt}{2,3ex}$W^*$ 				 & a        & b        & c        &  \\ \cline{1-4}
				\rule{0pt}{2,3ex}$C_D$                & $1.26492653341108$        & $1.20679001087588$        & $1.1891224168599$       &  \\ \cline{1-4}
				\rule{0pt}{2,3ex}$C_L$                & $-0.000508760643526784$        & $-0.00157058413712008$        & $-0.00054056507571687$        &  \\ \cline{1-4}
			\end{tabular}
	...
	\subsubsection{Simulation at Reynolds Number 100}
			...
			\end{table}
				...
				\begin{figure}[htp]	
					\centering
					\begin{tikzpicture}
					\begin{axis}[xlabel ={Position of Centre Point of the Cylinder}, ylabel ={$L_2$ Error of Entropy}, grid =major, legend entries ={$P=1$}, unbounded coords=jump, legend style = {cells = {anchor=east}, legend pos=outer north east,}, scaled x ticks = false, xmin = 0, xmax = 120]
					\addplot table[ x =x, y =y, mark=none] {data/CLRE100.dat};
					\end{axis}	
					\end{tikzpicture}
					\label{shijfterror}	
				...
				\begin{figure}[htp]	
					\centering
					\begin{tikzpicture}
					\begin{axis}[xlabel ={Position of Centre Point of the Cylinder}, ylabel ={$L_2$ Error of Entropy}, grid =major, legend entries ={$P=1$}, unbounded coords=jump, legend style = {cells = {anchor=east}, legend pos=outer north east,}, scaled x ticks = false]
					\addplot table[ x =x, y =y, mark=none] {data/CLRE100.dat};
					\end{axis}	
					\end{tikzpicture}
					\label{shijfterror}	
				...
				\begin{figure}[htp]	
					\centering
					\begin{tikzpicture}
					\begin{axis}[xlabel ={Position of Centre Point of the Cylinder}, ylabel ={$L_2$ Error of Entropy},  grid =major, legend entries ={$P=1$}, unbounded coords=jump, legend style = {cells = {anchor=east}, legend pos=outer north east,}, scaled x ticks = false, scaled y ticks = false, xmin = 300, xmax = 350]
					\addplot table[ x =x, y =y, mark=none] {data/CLRE100.dat};
					\end{axis}	
					\end{tikzpicture}
					\label{shijfterror}	
